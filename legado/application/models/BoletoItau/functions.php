...
//Guarda inicial
    ?>
    <img src="/images/boletos/p.png" width="<?php echo $fino ?>" height="<?php echo $altura ?>" border="0" /><img src="/images/boletos/b.png" width="<?php echo $fino ?>" height="<?php echo $altura ?>" border="0" /><img src="/images/boletos/p.png" width="<?php echo $fino ?>" height="<?php echo $altura ?>" border="0" /><img src="/images/boletos/b.png" width="<?php echo $fino ?>" height="<?php echo $altura ?>" border="0" /><img
    <?php
    $texto = $valor;
    if ((strlen($texto) % 2) <> 0) {
        $texto = "0" . $texto;
...
// Draw guarda final
        ?>
        src="/images/boletos/p.png" width="<?php echo $largo ?>" height="<?php echo $altura ?>" border="0" /><img src="/images/boletos/b.png" width="<?php echo $fino ?>" height="<?php echo $altura ?>" border="0" /><img src="/images/boletos/p.png" width="<?php echo 1 ?>" height="<?php echo $altura ?>" border="0">
    <?php
}
