...
class Erp_ProjetosPpciController extends Erp_Controller_Action {

    public function init() {
        $this->model = new ProjetosPpci_Model();
        ...
        $this->form = WS_Form_Generator::generateForm('ProjetosPpci', $this->model->getFormFields());
        parent::init();
    }
    ...
    public function formularioAction() {
        ...
        if(empty($dados['id'])):
            $this->model->_params['hora_inicial'] = date('H:i:s');
        endif;
    ...
    public function iniciaratividadeAction() {
        ...
        if (!empty($id)):
            try {
                ...
                $this->alerta('error', 'Erro ao alterar a Alteração PPCI de projeto! ' . $e->getMessage());
            }
        endif;
    }
