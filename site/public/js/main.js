...
--------------------------------------*/
$(function() {
    $('#ComoChegar').click(function() {
        const saida = $('#saida').val();
        if (saida != '') {
            window.open('https://www.google.com.br/maps/dir/' + saida + '/ACQUASANA+TRASNPORTE+E+TRATAMENTO+DE+EFLUENTES+-+R.+Tr%C3%AAs+de+Outubro,+40,+Bento+Gon%C3%A7alves+-+RS,+95700-000/@-29.1658821,-51.5136461,16z/?hl=pt-BR', '_blank');
        }
    });
});
function carregaMapa() {
    const latLang = new google.maps.LatLng(-29.17160, -51.51691);
    const Options = {
        zoom: 16,
        center: latLang,
    ...
    const map = new google.maps.Map(document.getElementById('mapa_canvas'), Options);

    new google.maps.Marker({
        position: latLang,
        map: map,
        title: 'Acquasana - Tratamento de Efluentes',
        clickable: false,
        icon: '/img/marker.png'
    });
}
