...
!function (jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        checkForStart: function (a) {
            ...
            if (a.preventTrigger = !0, a.state = 2, a.player.playVideo(), jQuery(a).YTPPause(), jQuery(a).muteYTPVolume(), jQuery("#controlBar_" + a.id).remove(), a.controlBar = !1, a.opt.showControls && jQuery.mbYTPlayer.buildControls(a), a.overlay) if (a.opt.addRaster) {
...
!function (e, t) {
    ...
    var s = function () {
        ...
        var n = t.createTexture(), a = t.createFramebuffer();
        t.bindFramebuffer(t.FRAMEBUFFER, a), t.bindTexture(t.TEXTURE_2D, n), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.NEAREST), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.NEAREST), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE);
        for (var s = null, u = 0; u < i.length; u++) if (t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, 32, 32, 0, t.RGBA, i[u].type, null), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, n, 0), t.checkFramebufferStatus(t.FRAMEBUFFER) === t.FRAMEBUFFER_COMPLETE) {
            s = i[u];
            break
        }
        return s
    ...
    var h = function (r, i) {
        ...
        for (var a = s.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, h = 0; h < 2; h++) {
            var c = t.createTexture(), d = t.createFramebuffer();
    ...
    h.DEFAULTS = {
        ...
        setupPointerEvents: function () {
            ...
            if (r != this.imageSource) if (this.imageSource = r, this.imageSource) {
                var i = new Image;
                i.onload = function () {
                    function r(e) {
                        return 0 == (e & e - 1)
            ...
            var e, t = this.$el.css("background-size"), o = this.$el.css("background-attachment"), n = function (e) {
                var t = e.split(" ");
            ...
            if ("fixed" == o ? ((e = {
                ...
                u = this.backgroundHeight * a; else if ("contain" == t) a = Math.min(e.width / this.backgroundWidth, e.height / this.backgroundHeight), s = this.backgroundWidth * a, u = this.backgroundHeight * a; else {
            ...
            t = this.context;
            var a = this.$el.innerWidth(), s = this.$el.innerHeight(), u = Math.max(a, s);
            i /= u;
    ...
    e.fn.ripples = function (t) {
        ...
        return this.each(function () {
            var i = e(this), o = i.data("ripples"), n = e.extend({}, h.DEFAULTS, i.data(), "object" == typeof t && t);
