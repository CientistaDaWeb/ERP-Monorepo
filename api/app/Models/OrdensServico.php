...
class OrdensServico extends LogTrait
{
  ...
  {
    return $this->belongsTo('App\Models\ClientesEnderecos', 'endereco_id', 'id');
  }

  public function orcamento()
  {
    return $this->belongsTo('App\Models\Orcamentos', 'orcamento_id', 'id');
  }
  ...
  {
    return $this->hasMany('App\Models\Mtrs', 'ordem_servico_id');
  }
