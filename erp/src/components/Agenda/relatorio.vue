          ...
          <div class="col col-xs-12">
            <div class="row q-col-gutter-md">
              ...
              <div class="col col-md-5 col-xs-12">
                <q-select
                  :options="functionario"
                  v-model="model.functionario"
                  label="Funcionário"
                  data-vv-name="functionario"
                  :error="errors.has('functionario')"
                  :error-message="errors.first('functionario')"
                />
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    filtrar () {
      ...
      this.$store.dispatch('relatorios/relatorio', { relatorio: 'agenda', data: data })
        .then(() => {
  ...
  computed: {
    status () {
      return this.$store.state.agenda.status
    },
    functionario () {
